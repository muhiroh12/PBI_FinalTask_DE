...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [BranchID] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([BranchID],[BranchName],[BranchLocation]) VALUES (?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [BranchName] = ?,[BranchLocation] = ? WHERE [BranchID] = ?";
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row1.BranchName);
}

                        if(row1.BranchLocation == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row1.BranchLocation);
}
...
} else {pstmtInsert_tDBOutput_1.setString(2, row1.BranchName);
}

                        if(row1.BranchLocation == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, row1.BranchLocation);
}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	int count_tDBOutput_2=0;
        ...
        String insert_tDBOutput_2 = "INSERT INTO [" + tableName_tDBOutput_2 + "] ([CustomerID],[CustomerName],[Address],[Age],[Gender],[Email],[CityName],[StateName]) VALUES (?,?,?,?,?,?,?,?)";
        ...
        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [CustomerName] = ?,[Address] = ?,[Age] = ?,[Gender] = ?,[Email] = ?,[CityName] = ?,[StateName] = ? WHERE [CustomerID] = ?";
...
} else {pstmt_tDBOutput_2.setInt(1, out1.CustomerID);
}
...
} else {pstmtUpdate_tDBOutput_2.setInt(8 + count_tDBOutput_2, out1.CustomerID);
}
...
} else {pstmtInsert_tDBOutput_2.setInt(1, out1.CustomerID);
}

                        if(out1.CustomerName == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, out1.CustomerName);
}

                        if(out1.Address == null) {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(3, out1.Address);
}

                        if(out1.Age == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, out1.Age);
}

                        if(out1.Gender == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, out1.Gender);
}

                        if(out1.Email == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, out1.Email);
}

                        if(out1.CityName == null) {
pstmtInsert_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(7, out1.CityName);
}

                        if(out1.StateName == null) {
pstmtInsert_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(8, out1.StateName);
}
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	...
	int count_tDBOutput_4=0;
        ...
        java.sql.PreparedStatement pstmt_tDBOutput_4 = conn_tDBOutput_4.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_4 + "] WHERE [AccountID] = ?");
        resourceMap.put("pstmt_tDBOutput_4", pstmt_tDBOutput_4);
        String insert_tDBOutput_4 = "INSERT INTO [" + tableName_tDBOutput_4 + "] ([AccountID],[CustomerID],[AccountType],[Balance],[DateOpened],[Status]) VALUES (?,?,?,?,?,?)";
        ...
        String update_tDBOutput_4 = "UPDATE [" + tableName_tDBOutput_4 + "] SET [CustomerID] = ?,[AccountType] = ?,[Balance] = ?,[DateOpened] = ?,[Status] = ? WHERE [AccountID] = ?";
 	...
 	boolean isShareIdentity_tDBOutput_4 = globalMap.get("shareIdentitySetting_tDBConnection_2") != null && (Boolean)globalMap.get("shareIdentitySetting_tDBConnection_2") == true;
...
} else {pstmt_tDBOutput_4.setInt(1, row3.AccountID);
}
...
} else {pstmtUpdate_tDBOutput_4.setInt(1, row3.CustomerID);
}

                        if(row3.AccountType == null) {
pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(2, row3.AccountType);
}

                        if(row3.Balance == null) {
pstmtUpdate_tDBOutput_4.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_4.setInt(3, row3.Balance);
}

                        if(row3.DateOpened != null) {
pstmtUpdate_tDBOutput_4.setTimestamp(4, new java.sql.Timestamp(row3.DateOpened.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_4.setString(5, row3.Status);
}
...
} else {pstmtUpdate_tDBOutput_4.setInt(6 + count_tDBOutput_4, row3.AccountID);
}
...
} else {pstmtInsert_tDBOutput_4.setInt(1, row3.AccountID);
}

                        if(row3.CustomerID == null) {
pstmtInsert_tDBOutput_4.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_4.setInt(2, row3.CustomerID);
}

                        if(row3.AccountType == null) {
pstmtInsert_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(3, row3.AccountType);
}

                        if(row3.Balance == null) {
pstmtInsert_tDBOutput_4.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_4.setInt(4, row3.Balance);
}

                        if(row3.DateOpened != null) {
pstmtInsert_tDBOutput_4.setTimestamp(5, new java.sql.Timestamp(row3.DateOpened.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_4.setString(6, row3.Status);
}
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	...
	int count_tDBOutput_3=0;
        ...
        java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_3 + "] WHERE [TransactionID] = ?");
        resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);
        String insert_tDBOutput_3 = "INSERT INTO [" + tableName_tDBOutput_3 + "] ([TransactionID],[AccountID],[BranchID],[TransactionDate],[Amount],[TransactionType]) VALUES (?,?,?,?,?,?)";
        ...
        String update_tDBOutput_3 = "UPDATE [" + tableName_tDBOutput_3 + "] SET [AccountID] = ?,[BranchID] = ?,[TransactionDate] = ?,[Amount] = ?,[TransactionType] = ? WHERE [TransactionID] = ?";
 	...
 	boolean isShareIdentity_tDBOutput_3 = globalMap.get("shareIdentitySetting_tDBConnection_2") != null && (Boolean)globalMap.get("shareIdentitySetting_tDBConnection_2") == true;
...
new_tUniqRow_1.transaction_id = row7.transaction_id;
	...
	row8 = new row8Struct();
}row8.transaction_id = row7.transaction_id;			row8.account_id = row7.account_id;			row8.transaction_date = row7.transaction_date;			row8.amount = row7.amount;			row8.transaction_type = row7.transaction_type;			row8.branch_id = row7.branch_id;					
...
} else {pstmt_tDBOutput_3.setInt(1, out2.TransactionID);
}
...
} else {pstmtUpdate_tDBOutput_3.setInt(1, out2.AccountID);
}

                        if(out2.BranchID == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_3.setInt(2, out2.BranchID);
}

                        if(out2.TransactionDate != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(out2.TransactionDate.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_3.setInt(4, out2.Amount);
}

                        if(out2.TransactionType == null) {
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5, out2.TransactionType);
}
...
} else {pstmtUpdate_tDBOutput_3.setInt(6 + count_tDBOutput_3, out2.TransactionID);
}
...
} else {pstmtInsert_tDBOutput_3.setInt(1, out2.TransactionID);
}

                        if(out2.AccountID == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_3.setInt(2, out2.AccountID);
}

                        if(out2.BranchID == null) {
pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_3.setInt(3, out2.BranchID);
}

                        if(out2.TransactionDate != null) {
pstmtInsert_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(out2.TransactionDate.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setInt(5, out2.Amount);
}

                        if(out2.TransactionType == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, out2.TransactionType);
}
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/PBI-FinalTask/Dataset/transaction_csv.csv", "US-ASCII",",","\n",false,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"transaction_id", "row5", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"account_id", "row5", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"transaction_date", "row5", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"amount", "row5", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							row5.transaction_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"branch_id", "row5", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:L9G4SL1FSxrOxLASkyK+aTfNrW0MMkTtkWc3bg==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row6.transaction_id = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row6.account_id = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				...
				if(2<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row6.transaction_date = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy HH:mm:ss");
...
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row6.amount = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row6.amount = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row6.branch_id = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row6.branch_id = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
	...
	String message_tSendMail_1 = (("DWHJOB has succeeded") == null || "".equals("DWHJOB has succeeded")) ? "\"\"" : ("DWHJOB has succeeded") ;
	...
	final String decryptedPassword_tSendMail_1 = context.emailPassword; 
				...
				return new javax.mail.PasswordAuthentication(context.emailUsername, decryptedPassword_tSendMail_1); 
				}         
			});   
 ...
 */
	...
	String message_tSendMail_2 = (("The DWHJOB has failed. Please check the job details below: \nJob name: DWHJOB \nDirectory: d/PBI-FinalTask/") == null || "".equals("The DWHJOB has failed. Please check the job details below: \nJob name: DWHJOB \nDirectory: d/PBI-FinalTask/")) ? "\"\"" : ("The DWHJOB has failed. Please check the job details below: \nJob name: DWHJOB \nDirectory: d/PBI-FinalTask/") ;
	...
	final String decryptedPassword_tSendMail_2 = context.emailPassword; 
				...
				return new javax.mail.PasswordAuthentication(context.emailUsername, decryptedPassword_tSendMail_2); 
				}         
			});   
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DWHJOB.class.getClassLoader().getResourceAsStream("pbi_finaltask/dwhjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DWHJOB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     312243 characters generated by Talend Open Studio for Data Integration 
 *     on the December 28, 2024 at 11:34:51 PM WIB
 ************************************************************************************************/