...
public class TMSSqlOutputMainJava {
  ...
  protected final String TEXT_39 = ".setNull(counter";
  protected final String TEXT_40 = ",java.sql.Types.CHAR);";
  protected final String TEXT_41 = ",java.sql.Types.DATE);";
  protected final String TEXT_42 = ",java.sql.Types.ARRAY);";
  protected final String TEXT_43 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_44 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_45 = ",java.sql.Types.OTHER);";
  protected final String TEXT_46 = ",java.sql.Types.BOOLEAN);";
  protected final String TEXT_47 = ",java.sql.Types.DOUBLE);";
  protected final String TEXT_48 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_49 = NL + "                }else{";
  protected final String TEXT_50 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_51 = ").toLowerCase())){";
  protected final String TEXT_52 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_53 = " == '\\0'){" + NL;
  protected final String TEXT_54 = ".setString(counter";
  protected final String TEXT_55 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_56 = ",String.valueOf(";
  protected final String TEXT_57 = "));" + NL + "                }";
  protected final String TEXT_58 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_61 = " < year1_";
  protected final String TEXT_62 = " || date_";
  protected final String TEXT_63 = " >= year10000_";
  protected final String TEXT_64 = ") {";
  protected final String TEXT_65 = ", \"0000-00-00 00:00:00\");" + NL + "                \t}else{";
  protected final String TEXT_66 = NL + "                    \t";
  protected final String TEXT_67 = ",TalendDate.formatDate(";
  protected final String TEXT_68 = ", ";
  protected final String TEXT_69 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_71 = ",TalendDate.formatDatetimeoffset(";
  protected final String TEXT_72 = NL + "                \t\t";
  protected final String TEXT_73 = ".setTimestamp(counter";
  protected final String TEXT_74 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_75 = "),calendar_datetimeoffset_";
  protected final String TEXT_76 = ");" + NL + "                \t";
  protected final String TEXT_77 = "));" + NL + "                \t";
  protected final String TEXT_78 = NL + "                    }" + NL + "                }else{";
  protected final String TEXT_79 = ",";
  protected final String TEXT_80 = ");" + NL + "" + NL + "                }";
  protected final String TEXT_81 = ".setObject(counter";
  protected final String TEXT_82 = ",java.sql.Types.DECIMAL,";
  protected final String TEXT_83 = ".set";
  protected final String TEXT_84 = "(counter";
  protected final String TEXT_85 = NL + NL + "                }" + NL;
  protected final String TEXT_86 = NL + "\t\tquery_";
  protected final String TEXT_87 = " = new StringBuffer(\"\");";
  protected final String TEXT_88 = NL + "\t\tif(nb_line_";
  protected final String TEXT_89 = "==0) {" + NL + "\t\t";
  protected final String TEXT_90 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_91 = " = conn_";
  protected final String TEXT_92 = ".createStatement()) {";
  protected final String TEXT_93 = NL + "                              stmtDrop_";
  protected final String TEXT_94 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_101 = ".commit();";
  protected final String TEXT_102 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_103 = NL + "                              stmtCreate_";
  protected final String TEXT_104 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_105 = "));";
  protected final String TEXT_106 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_107 = ";" + NL + "\t                    if (";
  protected final String TEXT_108 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_109 = " = 0; x_";
  protected final String TEXT_110 = " < dynamic_";
  protected final String TEXT_111 = ".getColumnCount(); x_";
  protected final String TEXT_112 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_113 = " = dynamic_";
  protected final String TEXT_114 = ".getColumnMetadata(x_";
  protected final String TEXT_115 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_116 = ".setName(column_";
  protected final String TEXT_117 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_118 = ".execute(((\"";
  protected final String TEXT_119 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  protected final String TEXT_120 = ", \"";
  protected final String TEXT_121 = "\")";
  protected final String TEXT_122 = ".toUpperCase()";
  protected final String TEXT_123 = ")+\")";
  protected final String TEXT_124 = "\"));";
  protected final String TEXT_125 = NL + "                stmtCreate_";
  protected final String TEXT_126 = ")\");";
  protected final String TEXT_127 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_128 = ";" + NL + "                    if (";
  protected final String TEXT_129 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_130 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_131 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_132 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_133 = NL;
  protected final String TEXT_134 = NL + "                    String keyCheckTable_";
  protected final String TEXT_135 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_136 = "+\"][\"+";
  protected final String TEXT_137 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_138 = " + \"]\";";
  protected final String TEXT_139 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_140 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_141 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_142 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_143 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_144 = ")== null){//}";
  protected final String TEXT_145 = NL + "                                boolean whetherExist_";
  protected final String TEXT_146 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_147 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_148 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_149 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_150 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_151 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_152 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_159 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_160 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_165 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_166 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_179 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  ...
  protected final String TEXT_187 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_188 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_189 = " == null || dbschema_";
  protected final String TEXT_190 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_191 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_192 = " = stmtSchema_";
  protected final String TEXT_193 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_194 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_195 = " = rsSchema_";
  protected final String TEXT_196 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_197 = ".toLowerCase()";
  protected final String TEXT_198 = ") || ((dbschema_";
  protected final String TEXT_199 = " ==null || dbschema_";
  protected final String TEXT_200 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_201 = "(schema_";
  protected final String TEXT_202 = NL + "                                String tableForSearch_";
  protected final String TEXT_203 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_204 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_205 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_206 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_207 = " =  tableForSearch_";
  protected final String TEXT_208 = ".substring(1,tableForSearch_";
  protected final String TEXT_209 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_210 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_213 = ".getTables(null, conn_";
  protected final String TEXT_214 = ".getSchema(), tableForSearch_";
  protected final String TEXT_215 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_216 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_217 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_218 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_219 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_220 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_221 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_222 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_223 = ".getMetaData();";
  protected final String TEXT_224 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_225 = ".getTables(";
  protected final String TEXT_226 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_227 = ".getTables(conn_";
  protected final String TEXT_228 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  ...
  protected final String TEXT_234 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_239 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_240 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_241 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_242 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_243 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_244 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  protected final String TEXT_245 = NL + "                                        stmtCreate_";
  protected final String TEXT_246 = NL + "                                    }" + NL + "                                }";
  protected final String TEXT_247 = NL + "                                if(whetherExist_";
  protected final String TEXT_248 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_249 = NL + "                                                      stmtDrop_";
  protected final String TEXT_250 = NL + "                                        stmtDrop_";
  protected final String TEXT_251 = NL + "                                    }";
  protected final String TEXT_252 = NL + "                                            conn_";
  protected final String TEXT_253 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_254 = NL + "                                                  stmtCreate_";
  protected final String TEXT_255 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_256 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_257 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_258 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_259 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_260 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_261 = NL + "                                    stmtCreate_";
  protected final String TEXT_262 = NL + "                                }";
  protected final String TEXT_263 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_264 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_265 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_266 = NL + "                              stmtClear_";
  protected final String TEXT_267 = NL + "                stmtClear_";
  protected final String TEXT_268 = ".executeUpdate(\"";
  protected final String TEXT_269 = "\");";
  protected final String TEXT_270 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_271 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_272 = NL + "                              stmtTruncCount_";
  protected final String TEXT_273 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_274 = " = stmtTruncCount_";
  protected final String TEXT_275 = ".executeQuery(\"";
  protected final String TEXT_276 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_277 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_278 = " = rsTruncCount_";
  protected final String TEXT_279 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_280 = NL + "                              stmtTrunc_";
  protected final String TEXT_281 = NL + "                conn_";
  protected final String TEXT_282 = NL + "                stmtTrunc_";
  protected final String TEXT_283 = NL + "                    if(!conn_";
  protected final String TEXT_284 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_285 = ".commit();" + NL + "                    }";
  protected final String TEXT_286 = NL + "                deletedCount_";
  protected final String TEXT_287 = " += rsTruncCountNumber_";
  protected final String TEXT_288 = ";" + NL + "            }";
  protected final String TEXT_289 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_290 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_291 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_292 = NL + "                while(rsTruncCount_";
  protected final String TEXT_293 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_294 = " += rsTruncCount_";
  protected final String TEXT_295 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_303 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_304 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_305 = NL + "        //String insert_";
  protected final String TEXT_306 = ") VALUES (";
  protected final String TEXT_307 = ")\";";
  protected final String TEXT_308 = NL + "        pstmt_";
  protected final String TEXT_309 = ".prepareStatement(insert_";
  protected final String TEXT_310 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_311 = "\", pstmt_";
  protected final String TEXT_312 = NL + "\t\tpstmt_";
  protected final String TEXT_313 = " = null;" + NL + "        // [%connection%][psmt][tableName]" + NL + "        String keyPsmt_";
  protected final String TEXT_314 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_315 = " + \"]\";" + NL + "\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_316 = ")== null){" + NL + "\t\t\tpstmt_";
  protected final String TEXT_317 = ");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_318 = ");" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_319 = ", pstmt_";
  protected final String TEXT_320 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_321 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_329 = " + \"] SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_330 = ".prepareStatement(update_";
  protected final String TEXT_331 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_332 = " + \"] WHERE ";
  protected final String TEXT_333 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_334 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_335 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_336 = "\", pstmtInsert_";
  protected final String TEXT_337 = ");" + NL + "        pstmtUpdate_";
  protected final String TEXT_338 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_339 = "\", pstmtUpdate_";
  protected final String TEXT_340 = NL + "        pstmtUpdate_";
  protected final String TEXT_341 = NL + "        String delete_";
  protected final String TEXT_342 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_343 = ".prepareStatement(delete_";
  protected final String TEXT_344 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_345 = NL + "       \t";
  protected final String TEXT_346 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_347 = " = insert_";
  protected final String TEXT_348 = ".split(\"\\\\?\");";
  protected final String TEXT_349 = NL + "\t\t\tupdate_";
  protected final String TEXT_350 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_351 = " = update_";
  protected final String TEXT_352 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_353 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_354 = NL + "\t\t\tdelete_";
  protected final String TEXT_355 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_356 = " = delete_";
  protected final String TEXT_357 = NL + "\t\t\treplace_";
  protected final String TEXT_358 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_359 = " = replace_";
  protected final String TEXT_360 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_361 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_362 = " = insertIgnore_";
  protected final String TEXT_363 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_364 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_365 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_366 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_367 = NL + "            stmt_";
  protected final String TEXT_368 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_369 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_370 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_371 = " = buffersSize_";
  protected final String TEXT_372 = ";";
  protected final String TEXT_373 = NL + "\t\t\tbatchSize_";
  protected final String TEXT_374 = NL + NL;
  protected final String TEXT_375 = NL + "\t        if(isShareIdentity_";
  protected final String TEXT_376 = ") {" + NL + "\t            stmt_";
  protected final String TEXT_377 = NL + "        whetherReject_";
  protected final String TEXT_378 = " = false;";
  protected final String TEXT_379 = NL + "            try {";
  protected final String TEXT_380 = NL + "                        query_";
  protected final String TEXT_381 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_382 = ",insertSQLSplits_";
  protected final String TEXT_383 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_384 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_385 = NL + "                globalMap.put(\"";
  protected final String TEXT_386 = "_QUERY\", query_";
  protected final String TEXT_387 = ".toString().trim());";
  protected final String TEXT_388 = NL + "        \t\tpstmt_";
  protected final String TEXT_389 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_390 = "++;" + NL + "        \t\t";
  protected final String TEXT_391 = NL + "    \t\t ";
  protected final String TEXT_392 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_393 = "++;" + NL + "    \t\t";
  protected final String TEXT_394 = NL + "                nb_line_";
  protected final String TEXT_395 = "++;";
  protected final String TEXT_396 = NL + "                int processedCount_";
  protected final String TEXT_397 = " = pstmt_";
  protected final String TEXT_398 = ".executeUpdate();" + NL + "                insertedCount_";
  protected final String TEXT_399 = " += processedCount_";
  protected final String TEXT_400 = ";" + NL + "                rowsToCommitCount_";
  protected final String TEXT_401 = NL + "            } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_402 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                whetherReject_";
  protected final String TEXT_403 = " = true;";
  protected final String TEXT_404 = NL + "                    throw(e);";
  protected final String TEXT_405 = " = new ";
  protected final String TEXT_406 = "Struct();";
  protected final String TEXT_407 = NL + "                        rejectedCount_";
  protected final String TEXT_408 = " = rejectedCount_";
  protected final String TEXT_409 = " + 1;";
  protected final String TEXT_410 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_414 = NL + "\t\t     \tint counter";
  protected final String TEXT_415 = " = rowCount";
  protected final String TEXT_416 = " * ";
  protected final String TEXT_417 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  protected final String TEXT_418 = NL + "\t\t                        counter";
  protected final String TEXT_419 = "++;" + NL + "\t\t                        ";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_421 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_422 = ", counter";
  protected final String TEXT_423 = "-1, \"";
  protected final String TEXT_424 = "\");" + NL + "\t\t\t\t\t\t\t\tcounter";
  protected final String TEXT_425 = "+=count_dyn_";
  protected final String TEXT_426 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + NL + "\t\t                sInsertColValue";
  protected final String TEXT_428 = " = new BufferLine_";
  protected final String TEXT_429 = "(" + NL + "\t\t                ";
  protected final String TEXT_430 = NL + "\t\t                            ," + NL + "\t\t                            ";
  protected final String TEXT_431 = NL + "\t\t                        ";
  protected final String TEXT_432 = NL + "\t\t\t\t\t\t, ";
  protected final String TEXT_433 = NL + "\t\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t                );" + NL + "" + NL + "\t\t                sInsertColValueList";
  protected final String TEXT_435 = ".add(sInsertColValue";
  protected final String TEXT_436 = ");" + NL + "" + NL + "\t\t                rowCount";
  protected final String TEXT_437 = "++;" + NL + "\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_439 = NL + "\t\t                if(rowCount";
  protected final String TEXT_440 = " == ";
  protected final String TEXT_441 = "){" + NL + "\t\t                    int processedCount_";
  protected final String TEXT_442 = ".executeUpdate();" + NL + "\t\t                    insertedCount_";
  protected final String TEXT_443 = ";" + NL + "\t\t                    rowsToCommitCount_";
  protected final String TEXT_444 = ";" + NL + "\t\t                    sInsertColValueList";
  protected final String TEXT_445 = ".clear();" + NL + "\t\t                    rowCount";
  protected final String TEXT_446 = " = 0;" + NL + "\t\t                    counter";
  protected final String TEXT_447 = "=1;" + NL + "\t\t                }" + NL + NL + NL + NL;
  protected final String TEXT_448 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_449 = ",updateSQLSplits_";
  protected final String TEXT_450 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_456 = NL + "    \t\tpstmt_";
  protected final String TEXT_457 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_458 = NL + "    \t\t";
  protected final String TEXT_459 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_460 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_461 = NL + "            int checkCount_";
  protected final String TEXT_462 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_463 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_464 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_465 = " = rs_";
  protected final String TEXT_466 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_467 = " > 0) {";
  protected final String TEXT_468 = NL + "                            query_";
  protected final String TEXT_469 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_470 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_471 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_472 = ", pstmtUpdate_";
  ...
  protected final String TEXT_479 = NL + "\t\t\t\t\t\t\t         query_";
  protected final String TEXT_480 = NL + "                    globalMap.put(\"";
  protected final String TEXT_481 = NL + "                    int processedCount_";
  protected final String TEXT_482 = " = pstmtUpdate_";
  protected final String TEXT_483 = ".executeUpdate();" + NL + "                    updatedCount_";
  protected final String TEXT_484 = ";" + NL + "                    rowsToCommitCount_";
  protected final String TEXT_485 = ";" + NL + "                    nb_line_";
  protected final String TEXT_486 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_487 = NL + "                } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_488 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                    whetherReject_";
  protected final String TEXT_489 = NL + "                        throw(e);";
  protected final String TEXT_490 = NL + "                    \tnb_line_";
  protected final String TEXT_491 = "++;" + NL + "                    \t";
  protected final String TEXT_492 = NL + "                                ";
  protected final String TEXT_493 = NL + "                            rejectedCount_";
  protected final String TEXT_494 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_495 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_496 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_497 = ", pstmtInsert_";
  protected final String TEXT_498 = " = pstmtInsert_";
  protected final String TEXT_499 = ".executeUpdate();" + NL + "                    insertedCount_";
  protected final String TEXT_500 = NL + "                }" + NL + "            }";
  protected final String TEXT_501 = NL + "            int updateFlag_";
  protected final String TEXT_502 = "=0;";
  protected final String TEXT_503 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_504 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_505 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_506 = NL + "\t\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_507 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_508 = NL + "                updateFlag_";
  protected final String TEXT_509 = "=pstmtUpdate_";
  protected final String TEXT_510 = " = updatedCount_";
  protected final String TEXT_511 = "+updateFlag_";
  protected final String TEXT_512 = " += updateFlag_";
  protected final String TEXT_513 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_514 = " == 0) {" + NL + "            \t";
  protected final String TEXT_515 = NL + "\t\t\t\tquery_";
  protected final String TEXT_516 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_517 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_518 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_519 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_520 = NL + "                } finally {" + NL + "\t\t\t\t    ";
  ...
  protected final String TEXT_526 = ".executeUpdate();" + NL + "                deletedCount_";
  protected final String TEXT_527 = ";" + NL + "                nb_line_";
  protected final String TEXT_528 = NL + "                \tnb_line_";
  protected final String TEXT_529 = "++;" + NL + "                \t";
  protected final String TEXT_530 = NL + NL + "        java.sql.ResultSet rs_";
  protected final String TEXT_531 = ".executeQuery();" + NL + "        int checkCount_";
  protected final String TEXT_532 = " = -1;" + NL + "        while(rs_";
  protected final String TEXT_533 = ".next()) {" + NL + "            checkCount_";
  protected final String TEXT_534 = ".getInt(1);" + NL + "        }" + NL + "" + NL + "        if (checkCount_";
  protected final String TEXT_535 = " < 1) {";
  protected final String TEXT_536 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_537 = NL + "                throw(e);";
  protected final String TEXT_538 = NL + "            \tnb_line_";
  protected final String TEXT_539 = "++;" + NL + "            \t";
  protected final String TEXT_540 = NL + "\t            ";
  protected final String TEXT_541 = NL + "                \trejectedCount_";
  protected final String TEXT_542 = " + 1;" + NL + "                \t";
  protected final String TEXT_543 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_544 = NL + "            if(!whetherReject_";
  protected final String TEXT_545 = NL + "            \t//////////batch execute by batch size///////" + NL + "            \tclass LimitBytesHelper_";
  protected final String TEXT_546 = "{" + NL + "            \t\tpublic int limitBytePart1(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_547 = ") throws Exception {" + NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_548 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_549 = ": pstmt_";
  protected final String TEXT_550 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_551 = " == -2 || countEach_";
  protected final String TEXT_552 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_553 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_554 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "globalMap.put(\"";
  protected final String TEXT_555 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                \t";
  protected final String TEXT_556 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_557 = NL + "                \tint countSum_";
  protected final String TEXT_558 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_559 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_560 = " < 0 ? 0 : countEach_";
  protected final String TEXT_561 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_562 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_563 = NL + "               \t\t\t }" + NL + "    \t\t\t\treturn counter;" + NL + "            \t}" + NL + "            \t" + NL + "            \tpublic int limitBytePart2(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_564 = ") throws Exception {" + NL + "                try {" + NL + "                \t\t";
  protected final String TEXT_565 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_566 = NL + "                \t" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_567 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_568 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_569 = NL + "                \t\t}\t" + NL + "                \treturn counter;\t" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_570 = NL + "    \t\tif ((batchSize_";
  protected final String TEXT_571 = " > 0) && (batchSize_";
  protected final String TEXT_572 = " <= batchSizeCounter_";
  protected final String TEXT_573 = ")) {" + NL + "    \t\t" + NL + "    \t\t            ";
  protected final String TEXT_574 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_575 = " = new LimitBytesHelper_";
  protected final String TEXT_576 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_577 = ",pstmt_";
  protected final String TEXT_578 = ");" + NL + "            \t    \t\trowsToCommitCount_";
  protected final String TEXT_579 = " = insertedCount_";
  protected final String TEXT_580 = ";" + NL + "            \t    \t";
  protected final String TEXT_581 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_582 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_583 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_584 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_585 = ");" + NL + "            \t    \t    rowsToCommitCount_";
  protected final String TEXT_586 = " = deletedCount_";
  protected final String TEXT_587 = NL + "    \t\t\t" + NL + "\t\t\t    batchSizeCounter_";
  protected final String TEXT_588 = " = 0;" + NL + "\t\t\t}" + NL + "    \t\t";
  protected final String TEXT_589 = NL + NL + "    \t////////////commit every////////////" + NL + "    \t\t\t";
  protected final String TEXT_590 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_591 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_592 = " <= commitCounter_";
  protected final String TEXT_593 = NL + "                if ((batchSize_";
  protected final String TEXT_594 = " > 0) && (batchSizeCounter_";
  ...
  protected final String TEXT_598 = " = 0;" + NL + "            \t}";
  protected final String TEXT_599 = NL + "                if(rowsToCommitCount_";
  protected final String TEXT_600 = " != 0){" + NL + "                \t";
  protected final String TEXT_601 = NL + "                }" + NL + "                conn_";
  protected final String TEXT_602 = ".commit();" + NL + "                if(rowsToCommitCount_";
  protected final String TEXT_603 = NL + "                \trowsToCommitCount_";
  protected final String TEXT_604 = " = 0;\t" + NL + "                }" + NL + "                commitCounter_";
  protected final String TEXT_605 = "=0;" + NL + "                }";
  protected final String TEXT_606 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_607 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_608 = " +\"] OFF\");" + NL + "        }";
...
DBLogUtil dbLog = null;
    ...
    stringBuffer.append(typeToSetNull );
    stringBuffer.append(TEXT_80);
    
            }else if(("BigDecimal").equals(typeToGenerate) && column.getColumn().getPrecision() != null){
    ...
    stringBuffer.append(column.getColumn().getPrecision());
    stringBuffer.append(TEXT_10);
