...
public class TMSSqlOutputEndJava {
  ...
  protected final String TEXT_35 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_36 = " ) {" + NL + "\t\t\tString setIdentityInsertONSQL_";
  protected final String TEXT_37 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_38 = " +\"] ON\";" + NL + "\t\t\t";
  protected final String TEXT_39 = NL + "        \tstmt_";
  protected final String TEXT_40 = ".execute(setIdentityInsertONSQL_";
  protected final String TEXT_41 = ");" + NL + "\t\t\t";
  protected final String TEXT_42 = NL + "        }";
  protected final String TEXT_43 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_44 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_45 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_46 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_47 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_48 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_49 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_50 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_51 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_52 = "\");" + NL + "        }";
  protected final String TEXT_53 = NL + "        if(pstmtInsert_";
  ...
  protected final String TEXT_58 = ",java.sql.Types.CHAR);" + NL + "\t\t";
  protected final String TEXT_59 = NL + "\t\t        if(bufferL";
  protected final String TEXT_60 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_61 = ",java.sql.Types.DATE);" + NL + "\t\t";
  protected final String TEXT_62 = ",java.sql.Types.ARRAY);" + NL + "\t\t";
  protected final String TEXT_63 = ",java.sql.Types.INTEGER);" + NL + "\t\t";
  protected final String TEXT_64 = ",java.sql.Types.VARCHAR);" + NL + "\t\t";
  protected final String TEXT_65 = ",java.sql.Types.OTHER);" + NL + "\t\t";
  protected final String TEXT_66 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t";
  protected final String TEXT_67 = ",java.sql.Types.DOUBLE);" + NL + "\t\t";
  protected final String TEXT_68 = ",java.sql.Types.FLOAT);" + NL + "\t\t";
  protected final String TEXT_69 = NL + NL + "\t\t        }else{" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\t";
  protected final String TEXT_71 = "==null){" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t\t        if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_73 = ").toLowerCase())){" + NL + "\t\t";
  protected final String TEXT_74 = NL + "\t\t    ";
  protected final String TEXT_75 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t    } else if(bufferL";
  protected final String TEXT_76 = " == '\\0') {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_77 = ".setString(count";
  protected final String TEXT_78 = ",\"\");" + NL + "" + NL + "\t\t    } else {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_79 = ",String.valueOf(bufferL";
  protected final String TEXT_80 = "));" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_81 = "!=null){" + NL + "\t\t            // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t            date_";
  protected final String TEXT_82 = " = bufferL";
  protected final String TEXT_83 = ".getTime();" + NL + "\t\t            if (date_";
  protected final String TEXT_84 = " < year1_";
  protected final String TEXT_85 = " || date_";
  protected final String TEXT_86 = " >= year10000_";
  protected final String TEXT_87 = ") {" + NL + "\t\t                ";
  protected final String TEXT_88 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  protected final String TEXT_89 = NL + "                    \t";
  protected final String TEXT_90 = ",TalendDate.formatDate(";
  protected final String TEXT_91 = ", ";
  protected final String TEXT_92 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_94 = ",TalendDate.formatDatetimeoffset(";
  protected final String TEXT_95 = NL + "\t\t                ";
  protected final String TEXT_96 = ".setTimestamp(count";
  protected final String TEXT_97 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_98 = NL + "\t\t         ";
  protected final String TEXT_99 = "),calendar_datetimeoffset_";
  protected final String TEXT_100 = ");" + NL + "\t\t         ";
  protected final String TEXT_101 = NL + "\t\t         \t\t";
  protected final String TEXT_102 = "));" + NL + "\t\t         ";
  protected final String TEXT_103 = NL + "\t\t\t\t";
  protected final String TEXT_104 = NL + "\t\t            }" + NL + "\t\t        }else{";
  protected final String TEXT_105 = ",";
  protected final String TEXT_106 = ");" + NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t\t        ";
  protected final String TEXT_108 = ".setObject(count";
  protected final String TEXT_109 = ",bufferL";
  protected final String TEXT_110 = ",java.sql.Types.DECIMAL,";
  protected final String TEXT_111 = ");" + NL + "\t\t        ";
  protected final String TEXT_112 = ".set";
  protected final String TEXT_113 = "(count";
  protected final String TEXT_114 = NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\tif(rowCount";
  protected final String TEXT_116 = "!=0){" + NL + "" + NL + "\t\tStringBuilder singleQueryInsertValueStmt = new StringBuilder();" + NL + "\t\tfor(int i=0 ; i < rowCount";
  protected final String TEXT_117 = " ; i++){" + NL + "\t\t     singleQueryInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_118 = "+\")\");" + NL + "\t\t     if (i != rowCount";
  protected final String TEXT_119 = " - 1)" + NL + "\t\t    \t singleQueryInsertValueStmt.append(\",\");" + NL + "\t\t}" + NL + "" + NL + "\t\tinsert_";
  protected final String TEXT_120 = " = \"INSERT INTO \"+";
  protected final String TEXT_121 = "+\" (\"+insertColName";
  protected final String TEXT_122 = "+\") VALUES \"+singleQueryInsertValueStmt.toString();" + NL + "" + NL + "\t\tpstmt_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".prepareStatement(insert_";
  protected final String TEXT_125 = ");" + NL + "\t\tint row2Count";
  protected final String TEXT_126 = " = 0;" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t\tint count";
  protected final String TEXT_128 = " = 1;" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\tint count";
  protected final String TEXT_130 = NL + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_131 = " bufferL";
  protected final String TEXT_132 = " : sInsertColValueList";
  protected final String TEXT_133 = "){" + NL + "\t\t";
  protected final String TEXT_134 = NL + "\t\t    \tcount";
  protected final String TEXT_135 = " = row2Count";
  protected final String TEXT_136 = "*";
  protected final String TEXT_137 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t            count";
  protected final String TEXT_139 = "++;" + NL + "\t\t            ";
  protected final String TEXT_140 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_141 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_149 = "++;" + NL + "\t\t}" + NL + "\t\tint processedCount_";
  protected final String TEXT_150 = " = pstmt_";
  protected final String TEXT_151 = ".executeUpdate();" + NL + "\t\tinsertedCount_";
  protected final String TEXT_152 = " += processedCount_";
  protected final String TEXT_153 = ";" + NL + "\t\trowsToCommitCount_";
  protected final String TEXT_154 = ";" + NL + "\t\t}";
  protected final String TEXT_155 = NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_156 = " = 0;" + NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_157 = " != null && batchSizeCounter_";
  protected final String TEXT_158 = " > 0) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_160 = ": pstmt_";
  protected final String TEXT_161 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_162 = " == -2 || countEach_";
  protected final String TEXT_163 = " == -3) {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_164 = " += countEach_";
  protected final String TEXT_165 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_166 = " += countSum_";
  protected final String TEXT_167 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_169 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_170 = ";" + NL + "            \t    \t";
  protected final String TEXT_171 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_172 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_173 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "globalMap.put(\"";
  protected final String TEXT_174 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                \t";
  protected final String TEXT_175 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_176 = NL + "                \tint countSum_";
  protected final String TEXT_177 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_178 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_179 = " += (countEach_";
  protected final String TEXT_180 = " < 0 ? 0 : countEach_";
  protected final String TEXT_181 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_182 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_183 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_184 = NL + "            \t}";
  protected final String TEXT_185 = NL + "        if(pstmt_";
  protected final String TEXT_186 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_188 = ".close();" + NL + "\t\t\t\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_189 = "\");" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_191 = NL + "    String setIdentityInsertOFFSQL_";
  protected final String TEXT_192 = " +\"] OFF\";";
  protected final String TEXT_193 = NL + "    stmt_";
  protected final String TEXT_194 = ".execute(setIdentityInsertOFFSQL_";
  protected final String TEXT_195 = ".close();";
  protected final String TEXT_196 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_197 = "\", true);";
  protected final String TEXT_198 = NL + "            if(rowsToCommitCount_";
  protected final String TEXT_199 = " != 0){" + NL + "            \t";
  protected final String TEXT_200 = NL + "            }" + NL + "            conn_";
  protected final String TEXT_201 = ".commit();" + NL + "            if(rowsToCommitCount_";
  protected final String TEXT_202 = NL + "            \trowsToCommitCount_";
  protected final String TEXT_203 = " = 0;" + NL + "            }" + NL + "            commitCounter_";
  ...
  protected final String TEXT_208 = NL + "\tnb_line_deleted_";
  protected final String TEXT_209 = "=nb_line_deleted_";
  protected final String TEXT_210 = "+ deletedCount_";
  protected final String TEXT_211 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_212 = "=nb_line_update_";
  protected final String TEXT_213 = " + updatedCount_";
  protected final String TEXT_214 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_215 = "=nb_line_inserted_";
  protected final String TEXT_216 = " + insertedCount_";
  protected final String TEXT_217 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_218 = "=nb_line_rejected_";
  protected final String TEXT_219 = " + rejectedCount_";
  protected final String TEXT_220 = ";" + NL + "\t";
  protected final String TEXT_221 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_222 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_223 = "_NB_LINE\",nb_line_";
  protected final String TEXT_224 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_225 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_226 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_227 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_228 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_229 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_230 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_231 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_232 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_233 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_234 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_235 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_236 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_237 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_238 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_239 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_240 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_241 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_242 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_243 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_247 = "_NB_LINE_REJECTED\", nb_line_rejected_";
...
DBLogUtil dbLog = null;
    ...
    String connection = ElementParameterParser.getValue(node,"__CONNECTION__");
    if(useExistingConnection) {
        List<? extends INode> nodes = process.getNodesOfType("tMSSqlConnection");
        for (INode ne:nodes) {
