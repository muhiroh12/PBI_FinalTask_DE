...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_29 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_30 = " ;";
  protected final String TEXT_31 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_32 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_33 = NL + "\t\tString port_";
  protected final String TEXT_34 = ";" + NL + "\t\tString dbname_";
  ...
  protected final String TEXT_44 = " += \";databaseName=\" + ";
  protected final String TEXT_45 = NL + "    \t}" + NL;
  protected final String TEXT_46 = NL + "            url_";
  protected final String TEXT_47 = " += \";encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;Authentication=ActiveDirectoryPassword\";" + NL + "            url_";
  protected final String TEXT_48 = " += \";database=\" + ";
  ...
  protected final String TEXT_81 = NL + "                log.error(message_";
  protected final String TEXT_82 = NL + "                System.err.println(message_";
  ...
  protected final String TEXT_100 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_101 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\tconn_";
  protected final String TEXT_103 = NL + "\t\t\t\tlog.";
  ...
  protected final String TEXT_119 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_120 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tboolean inOSGi = routines.system.BundleUtils.inOSGi();" + NL + "\tif (!(inOSGi && dataSources_";
  protected final String TEXT_121 = " != null && ";
  protected final String TEXT_122 = ".replaceAll(\"\\\\s+\",\"\").length() > 0)) {";
  protected final String TEXT_123 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_124 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_125 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_126 = ".get(dsAlias_";
  protected final String TEXT_127 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_128 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_129 = " = dataSources_";
  protected final String TEXT_130 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_131 = ");" + NL + "\t}";
  protected final String TEXT_132 = NL + "\tif (null != conn_";
  protected final String TEXT_133 = ") {" + NL + "\t\t";
  protected final String TEXT_134 = NL + "\t}";
  protected final String TEXT_135 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_136 = "\", ";
  protected final String TEXT_137 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_138 = "\",  ";
  protected final String TEXT_139 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
  protected final String TEXT_140 = ");" + NL + "" + NL + "\tglobalMap.put(\"driver_";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(ElementParameterParser.getValue(node, "__DRIVER__"));
    stringBuffer.append(TEXT_10);
