...
public class TMSSqlCommitMainJava
{
  ...
  protected final String TEXT_60 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_61 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_62 = " != null && !conn_";
  protected final String TEXT_63 = ".isClosed())" + NL + "\t{" + NL + "\t";
  protected final String TEXT_64 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_65 = NL + "\t\t\t";
  protected final String TEXT_66 = NL + "\t";
  protected final String TEXT_67 = NL + "\t\t}finally{" + NL + "\t\t\t";
