...
public class TMSSqlRowEndJava
{
  ...
  protected final String TEXT_60 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_61 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_62 = NL + "\t";
  protected final String TEXT_63 = NL + "        pstmt_";
  protected final String TEXT_64 = ".close();" + NL + "        resourceMap.remove(\"pstmt_";
  protected final String TEXT_65 = "\");";
  protected final String TEXT_66 = NL + "        stmt_";
  protected final String TEXT_67 = ".close();" + NL + "        resourceMap.remove(\"stmt_";
  protected final String TEXT_68 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_69 = "\", true);";
  protected final String TEXT_70 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_71 = ">commitCounter_";
  protected final String TEXT_72 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t" + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_74 = "=0;" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_75 = NL + "    resourceMap.put(\"finish_";
