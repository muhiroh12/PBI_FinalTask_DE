...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_36 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_37 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_38 = " = 0;" + NL + "int nb_line_deleted_";
  ...
  protected final String TEXT_58 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        } else if (updateKeyCount_";
  protected final String TEXT_59 = " == ";
  protected final String TEXT_60 = " && ";
  protected final String TEXT_61 = ") {";
  protected final String TEXT_62 = "        " + NL + "                throw new RuntimeException(\"";
  protected final String TEXT_63 = "\");";
  protected final String TEXT_64 = NL + "                    log.warn(\"";
  protected final String TEXT_65 = NL + "                    System.err.println(\"";
  ...
  protected final String TEXT_70 = NL + "        int insertKeyCount_";
  protected final String TEXT_71 = ";" + NL + "        if(insertKeyCount_";
  protected final String TEXT_72 = " < 1) {" + NL + "            throw new RuntimeException(\"For insert if not exist, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_91 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_92 = NL + "    dbschema_";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "    String driverClass_";
  protected final String TEXT_95 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_96 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_97 = NL + "\t";
  protected final String TEXT_98 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_99 = ");" + NL + "    String port_";
  protected final String TEXT_100 = ";" + NL + "    String dbname_";
  protected final String TEXT_101 = " ;";
  protected final String TEXT_102 = NL + "    String url_";
  protected final String TEXT_103 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_104 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_105 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_106 = ")) {" + NL + "    \turl_";
  protected final String TEXT_107 = " += \":\" + ";
  protected final String TEXT_108 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_109 = ")) {";
  protected final String TEXT_110 = NL + "\t\t\t\turl_";
  protected final String TEXT_111 = " += \"//\" + ";
  protected final String TEXT_112 = "; " + NL + "\t";
  protected final String TEXT_113 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_114 = " += \";databaseName=\" + ";
  protected final String TEXT_115 = NL + "    }";
  protected final String TEXT_116 = NL + "        url_";
  protected final String TEXT_117 = " += \";encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;Authentication=ActiveDirectoryPassword\";" + NL + "        url_";
  ...
  protected final String TEXT_128 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_139 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_140 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_145 = NL + NL + "if(dbschema_";
  protected final String TEXT_146 = " == null || dbschema_";
  protected final String TEXT_147 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_148 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_154 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_165 = ".commit();";
  ...
  protected final String TEXT_170 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_171 = ";" + NL + "\t                    if (";
  protected final String TEXT_172 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_173 = " = 0; x_";
  protected final String TEXT_174 = " < dynamic_";
  protected final String TEXT_175 = ".getColumnCount(); x_";
  protected final String TEXT_176 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_177 = " = dynamic_";
  protected final String TEXT_178 = ".getColumnMetadata(x_";
  protected final String TEXT_179 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_180 = ".setName(column_";
  protected final String TEXT_181 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_182 = ".execute(((\"";
  protected final String TEXT_183 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_191 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_192 = ";" + NL + "                    if (";
  protected final String TEXT_193 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_194 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_195 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_196 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_208 = NL + "                                boolean whetherExist_";
  protected final String TEXT_209 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_210 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_211 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_212 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_213 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_214 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_215 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_222 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_223 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_227 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_228 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_229 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_243 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_244 = "((";
  protected final String TEXT_245 = ")";
  protected final String TEXT_246 = ") || (dbschema_";
  protected final String TEXT_247 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_248 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_249 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_250 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_251 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_252 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_253 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_254 = " = stmtSchema_";
  protected final String TEXT_255 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_256 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_257 = " = rsSchema_";
  protected final String TEXT_258 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_259 = ".toLowerCase()";
  protected final String TEXT_260 = ") || ((dbschema_";
  protected final String TEXT_261 = " ==null || dbschema_";
  protected final String TEXT_262 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_263 = "(schema_";
  protected final String TEXT_264 = NL + "                                String tableForSearch_";
  ...
  protected final String TEXT_272 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_277 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_278 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_279 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_280 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_281 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_282 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_283 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_284 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_294 = ".equalsIgnoreCase(";
  protected final String TEXT_295 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_296 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_297 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_298 = NL + "                                if(!whetherExist_";
  protected final String TEXT_299 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_300 = NL + "                                                      stmtCreate_";
  protected final String TEXT_301 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_302 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_303 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_304 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_305 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_306 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_310 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_317 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_318 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_319 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_320 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_321 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_322 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_323 = NL + "                                    stmtCreate_";
  protected final String TEXT_324 = NL + "                                }";
  protected final String TEXT_325 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_326 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_327 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_328 = NL + "                              stmtClear_";
  protected final String TEXT_329 = NL + "                stmtClear_";
  protected final String TEXT_330 = ".executeUpdate(\"";
  protected final String TEXT_331 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_332 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_333 = NL + "                              stmtTruncCount_";
  protected final String TEXT_334 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_335 = " = stmtTruncCount_";
  protected final String TEXT_336 = ".executeQuery(\"";
  protected final String TEXT_337 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_338 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_339 = " = rsTruncCount_";
  protected final String TEXT_340 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_341 = NL + "                              stmtTrunc_";
  protected final String TEXT_342 = NL + "                conn_";
  protected final String TEXT_343 = NL + "                stmtTrunc_";
  protected final String TEXT_344 = NL + "                    if(!conn_";
  protected final String TEXT_345 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_346 = ".commit();" + NL + "                    }";
  protected final String TEXT_347 = NL + "                deletedCount_";
  protected final String TEXT_348 = " += rsTruncCountNumber_";
  protected final String TEXT_349 = ";" + NL + "            }";
  protected final String TEXT_350 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_351 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_352 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_356 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_357 = NL + "        String insert_";
  protected final String TEXT_358 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_359 = " + \"] (";
  protected final String TEXT_360 = ") VALUES (";
  protected final String TEXT_361 = ")\";";
  protected final String TEXT_362 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_363 = ".prepareStatement(insert_";
  protected final String TEXT_364 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_365 = "\", pstmt_";
  protected final String TEXT_366 = " = null;" + NL + "        String keyPsmt_";
  protected final String TEXT_367 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_368 = " + \"]\";" + NL + "        pstmt_";
  protected final String TEXT_369 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_370 = ",insert_";
  protected final String TEXT_371 = ",keyPsmt_";
  ...
  protected final String TEXT_375 = " WHERE ";
  ...
  protected final String TEXT_378 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_382 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_383 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_384 = "\", pstmtInsert_";
  protected final String TEXT_385 = ");" + NL + "        String update_";
  protected final String TEXT_386 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_387 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_388 = "\", pstmtUpdate_";
  protected final String TEXT_389 = NL + "        String delete_";
  protected final String TEXT_390 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_391 = ".prepareStatement(delete_";
  protected final String TEXT_392 = NL + NL + "    class BufferLine_";
  protected final String TEXT_393 = " {";
  protected final String TEXT_394 = " ";
  protected final String TEXT_395 = NL + NL + "        public BufferLine_";
  protected final String TEXT_396 = NL + "                    ,";
  protected final String TEXT_397 = NL + "        ){";
  protected final String TEXT_398 = NL + "                    this.";
  ...
  protected final String TEXT_430 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_431 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_432 = NL + "\t\t\tdelete_";
  protected final String TEXT_433 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_434 = " = delete_";
  protected final String TEXT_435 = NL + "\t\t\treplace_";
  protected final String TEXT_436 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_437 = " = replace_";
  ...
  protected final String TEXT_441 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_442 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_443 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_444 = "\") == true;";
  protected final String TEXT_445 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_446 = ".createStatement();";
  protected final String TEXT_447 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_448 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_449 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_450 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_451 = NL + "            stmt_";
  protected final String TEXT_452 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_453 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_454 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_455 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_456 = " =null;" + NL + "\t";
  protected final String TEXT_457 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_461 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_462 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_463 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_464 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_465 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
